...
const VehiclePanel = (props) => {
  return (
    <div><h5 onClick={()=>{props.setVehiclePanel(false)}} className='p-1 text-center w-[93%] absolute top-0'><i className=' text-3xl text-gray-200 ri-arrow-down-wide-line'/></h5>
    <h3 className='text-2xl font-semibold mb-5'>Choose a Vehicle</h3>
    <div onClick={()=>{
      props.setConfirmRidePanel(true);
    }} className='flex border-2 active:border-black border-gray-300 mb-2 rounded-xl w-full items-center justify-between p-3'>
    ...
    <h2 className='text-lg font-semibold'>₹65.17</h2>
     ...
     <div  onClick={()=>{
      props.setConfirmRidePanel(true);
    }} className='flex border-2 active:border-black border-gray-300  rounded-xl w-full items-center justify-between p-3'>
